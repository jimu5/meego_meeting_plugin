    ...
    "definitions": {
        ...
        "larkcalendar.CalendarEvent": {
            ...
            "properties": {
                ...
                "recurrence": {
                    "description": "重复日程的重复性规则；参考[rfc5545](https://datatracker.ietf.org/doc/html/rfc5545#section-3.3.10)；;- 不支持COUNT和UNTIL同时出现；;- 预定会议室重复日程长度不得超过两年。",
                    "type": "string"
                },
                "recurring_event_id": {
        ...
        "larkcalendar.Schema": {
            ...
            "properties": {
                ...
                "ui_name": {
                    "description": "UI名称。取值范围如下： ;- ForwardIcon: 日程转发按钮 ;- MeetingChatIcon: 会议群聊按钮 ;- MeetingMinutesIcon: 会议纪要按钮 ;- MeetingVideo: 视频会议区域 ;- RSVP: 接受/拒绝/待定区域 ;- Attendee: 参与者区域 ;- OrganizerOrCreator: 组织者/创建者区域",
                    "type": "string"
                },
                "ui_status": {
